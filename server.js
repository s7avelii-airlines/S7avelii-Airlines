...
// Если сервер на продакшне за прокси
...
// Проверяем, что есть папка data и файл users.json
...
app.post('/api/register', async (req, res) => {
  try {
    ...
    const id = makeId();
    const newUser = { id, fio, phone, email: email || '', password: hashed, cart: [], role: 'user', createdAt: new Date().toISOString() };
